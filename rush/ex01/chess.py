...
def produce_valid_squares(chosen_piece, chosen_y_index, chosen_x_index):
    ...
    def bishop_squares(bishop, bishop_y_index, bishop_x_index):
        ...
        for i in chess_map[bishop_y_index::-1]:
            ...
            elif bishop_left_index < 0 or (piece_dict[i[bishop_left_index]]["color"] == bishop_color and bishop_up_index != bishop_y_index):
                bishop_up_index = bishop_y_index
                bishop_left_index = bishop_x_index
                break
        ...
        for i in chess_map[bishop_y_index::-1]:
            if i[bishop_right_index] == ".":
                bishop_squares.append((bishop_up_index, bishop_right_index))
            elif bishop_right_index == len(chess_map) or (piece_dict[i[bishop_right_index]]["color"] == bishop_color and bishop_up_index != bishop_y_index):
                bishop_up_index = bishop_y_index
                bishop_right_index = bishop_x_index
                break
        ...
        for i in chess_map[bishop_y_index:]:
            ...
            elif bishop_left_index < 0 or (piece_dict[i[bishop_left_index]]["color"] == bishop_color and bishop_down_index != bishop_y_index):
                bishop_down_index = bishop_y_index
                bishop_left_index = bishop_x_index
                break
            elif piece_dict[i[bishop_left_index]]["color"] != bishop_color:
        ...
        for i in chess_map[bishop_y_index:]:
            ...
            elif bishop_right_index == len(chess_map) or (piece_dict[i[bishop_right_index]]["color"] == bishop_color and bishop_down_index != bishop_y_index):
                bishop_down_index = bishop_y_index
                bishop_right_index = bishop_x_index
                break
            elif piece_dict[i[bishop_right_index]]["color"] != bishop_color:
